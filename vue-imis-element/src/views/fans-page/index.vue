  ...
  <div class="fans-page">
    <el-tabs v-model="activeName">
      <el-tab-pane label="用户管理" name="first">
        ...
        <el-button type="primary" style="margin: 10px; display: inline-block" @click="handleMongo"
          >写库</el-button
        >
        <el-table :data="fansList" style="width: 100%" border>
          <el-table-column prop="blo" label="blo" width="width"> </el-table-column>
          <el-table-column prop="email" label="email" width="width"> </el-table-column>
          <el-table-column prop="userName" label="用户名" width="width"> </el-table-column>
          <el-table-column prop="_id" label="_id" width="width"> </el-table-column>
